...
|---|---|---|---|---|---|---|
| npv_usd | USD | $22,034,000 | $890,507 | -96.0% | REopt NPV uses unlevered owner discount rate (8%) on unlever… | INFO |
| payback_years | years | 6.0 | 10.2 | +70.3% | REopt simple payback is based on avoided electricity cost vs… | WARN |
| year1_revenue_usd | USD | $5,056,418 | $4,980,450 | -1.5% |  | INFO |
...
### `payback_years`
- REopt: 10.2, Excel: 6.0, Delta: +70.3%
