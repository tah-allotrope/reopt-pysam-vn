"""
reopt_vietnam.py — Python module for preprocessing REopt input dicts with Vietnam-specific assumptions.

Mirror of the Julia module (src/REoptVietnam.jl). All Vietnam-specific values are loaded at
runtime from versioned JSON files in data/vietnam/, driven by manifest.json.
This module contains logic only — no hardcoded policy values.

Usage:
    from src.reopt_vietnam import load_vietnam_data, apply_vietnam_defaults, run_vietnam_reopt
    import json, os
