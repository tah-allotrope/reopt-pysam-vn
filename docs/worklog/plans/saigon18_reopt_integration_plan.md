...
**File:** `scripts/python/extract_excel_inputs.py`
...
**File:** `scripts/python/build_saigon18_reopt_input.py`
...
**File:** `scripts/python/compare_reopt_vs_excel.py`
...
**Implementation file:** `scripts/python/dppa_settlement.py`
...
**Implementation file:** `scripts/python/equity_irr.py`
...
**Workaround:** Add a custom JuMP constraint in `src/REoptVietnam.jl`:
...
**Workaround:**
- All REopt inputs that are VND-denominated (tariff, surplus purchase rate) are converted to USD using `convert_vnd_to_usd()` from `src/reopt_vietnam.py` at the fixed rate
...
**Tasks:**
1. Implement `scripts/python/extract_excel_inputs.py`
...
4. Add Layer 1 data validation tests:
   ```
   tests/python/test_saigon18_data.py
   ```
...
3. Implement `scripts/python/compare_reopt_vs_excel.py`:
...
4. Implement `scripts/python/dppa_settlement.py`:
...
**Tasks:**
1. Implement Decree 57 export cap as hard JuMP constraint in `src/REoptVietnam.jl`
...
4. Implement `scripts/python/equity_irr.py`:
...
5. Add Layer 4 integration test for Saigon18 scenarios:
   ```
   tests/python/test_saigon18_integration.py
   ```

**Deliverables:**
- Updated `src/REoptVietnam.jl` with Decree 57 hard constraint
...
*End of plan. Next step: begin Phase 1 data extraction. See `scripts/python/extract_excel_inputs.py`.*
