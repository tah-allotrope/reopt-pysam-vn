    ...
    phases.append(
        {
            ...
            + render_column(
                "Output",
                [
                    "Created `scripts/python/compare_north_thuan_reopt_vs_staff.py` and regression coverage in `tests/python/test_north_thuan_reopt.py`.",
    ...
    phases.append(
        {
            ...
            + render_column(
                "Output",
                [
                    "Extended `scripts/python/dppa_settlement.py` with `compute_virtual_dppa_developer_revenue()` for the North Thuan virtual-DPPA proxy.",
    ...
    phases.append(
        {
            ...
            + render_column(
                "Output",
                [
                    "Created `scripts/python/generate_north_thuan_reopt_report.py` and wrote `artifacts/reports/north_thuan/2026-03-31_north-thuan-reopt-validation.html`.",
                    "Created `scripts/python/generate_north_thuan_phase_reports.py` and generated six phase reports under `reports/` using the report-skill template shell.",
