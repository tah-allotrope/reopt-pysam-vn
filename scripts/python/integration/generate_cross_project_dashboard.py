...
Usage:
    python scripts/python/integration/generate_cross_project_dashboard.py \
...
<div class="page">
  ...
  <div class="footer">Generated by <code>scripts/python/integration/generate_cross_project_dashboard.py</code> ·
