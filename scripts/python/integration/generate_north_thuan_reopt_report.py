...
<div class="page">
  ...
  <div class="footer">Generated by <code>scripts/python/integration/generate_north_thuan_reopt_report.py</code> from <code>artifacts/reports/north_thuan/2026-03-31_north-thuan-reopt-validation.json</code></div>
</div>
<script>
